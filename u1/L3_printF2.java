...
public class L3_printF2 {
    public static void main(String[] args) {
        ...
        // main code
        // %f <- float holder (by default, any number you replace in the float holder
        ...
        System.out.printf("%15s%n", s); // SPACE RESERVATION - max up to 15 spaces ("e" in markvill"e" will line up to
                                        // the 15th space)
